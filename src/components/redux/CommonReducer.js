...
const reducers = {
    ...
    CREATE_UPC_COUPON_START:CreateUPCCouponReducer,
    CREATE_UPC_COUPON_SUCCESS:CreateUPCCouponReducer,
    CREATE_UPC_COUPON_FAILURE:CreateUPCCouponReducer,
}
