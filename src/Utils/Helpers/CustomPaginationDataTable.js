...
const CustomPaginationDataTable = (
    {
        data=[],
        columns =[],
        isEnableSearch=true,
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
            <div>
                <label>
                    ...
                    onChange={(e) => handleRowsChangeData(e)}
                             style={{
                                 width: "65px", 
                                 height: "30.8px", 
                                 marginRight: "5px", 
            ...
            <div  style={{ marginRight: "15px" }} className='table-filter'>
              <label>
                <input type='search' value={searchVal} name="searchVal" onChange={(e) => handleSearch(e)} />
              </label>
            </div>
        </div>
...
export default CustomPaginationDataTable
